	...
	public Product find(int id) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                return new Product(id, name, description, thumbnail, price, quantity, categoryId, created_at, view);
            }
        } catch (SQLException e) {
            // TODO Auto-generated catch block
            e.printStackTrace();
	...
	public List<Product> findAll() {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                int categoryId = rs.getInt("category_id");
                Timestamp created_at = rs.getTimestamp("created_at");
                prodList.add(new Product(id, name, description, thumbnail, price, quantity, categoryId, created_at, view));
            }
        } catch (SQLException e) {
            // TODO Auto-generated catch block
            e.printStackTrace();
